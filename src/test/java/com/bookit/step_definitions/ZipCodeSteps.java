...
import com.bookit.pages.USPZZipCodePage;
...
public class ZipCodeSteps {
    ...
    Response response;
    USPZZipCodePage zipCodePage = new USPZZipCodePage();
    ...
    public void city_name_should_be_in_response(String cityName) {
        assertThat(response.statusCode(), is(HttpStatus.SC_OK)); // ==>the same is(200)
